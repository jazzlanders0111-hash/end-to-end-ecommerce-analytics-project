...
**The High-Value at Risk segment is the fulcrum of the entire business.** Six percent of customers. Twenty-five percent of revenue. Second-highest churn rate among the four segments (32.3%, behind only the already-gone Lost Customers at 94.3%). Highest average fraud score. Lowest retention rate among high-LTV tiers. A 3.45× LTV premium over the next-best group. Every risk identified in this project is concentrated most severely in these 480 customers — and every potential upside is largest here too. This is where the business is most fragile and most improvable simultaneously.
